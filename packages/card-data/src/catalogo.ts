...
import { HABILIDADES_DO_MONGE } from './monge/habilidades.js';
import {
...
import { HABILIDADES_DO_DRUIDA } from './druida/habilidades.js';
import {
...
export const CARTAS_DO_MONGE: readonly DefinicaoDeCarta[] = [
  ...HABILIDADES_DO_MONGE,
  ...PASSIVAS_DO_MONGE,
  ...CARTAS_DE_CLASSE_DO_MONGE,
  ...ULTIMATES_DO_MONGE,
];
...
export const CARTAS_DO_DRUIDA: readonly DefinicaoDeCarta[] = [
  ...HABILIDADES_DO_DRUIDA,
  ...PASSIVAS_DO_DRUIDA,
  ...CARTAS_DE_CLASSE_DO_DRUIDA,
  ...ULTIMATES_DO_DRUIDA,
];
